        ...
        <div class="col-md-12 mb-3">
            <div class="px-3">
                <div class="card-header row" style="border: 1px solid black !important;">
                    <div class="col-md-12">
                        <button class="btn btn-sm btn-primary float-right" id="btn-tambahmateri">Add Exam</button>
                        <!-- 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('kelolasoal_exam',$v->id)}}" class="btn btn-primary">
                                                    <i class="fe fe-edit"></i>
                                                </a>
                                                <a href="{{url('kelolasoal_exam_delete',$v->id)}}" class="btn btn-danger" data-target="confirmation-modal">
                                                    <i class="fe fe-trash"></i>
                                                </a>
                                                <a href="{{url('soal_exam',$v->id)}}" class="btn btn-success text-white">
                                                    <i class="fe fe-eye"></i>
                                                </a>
    ...
    <div class="row">
        <div class="col-md-12  mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{url('kelolasoal_exam')}}" enctype="multipart/form-data" id="submitdata">
                        @csrf

                        <div class="col-md-9 p-0">
                            <input type="hidden" class="form-control input-full w-100" value="{{$exam_id}}" name="mapel_id" id="kelas_id" placeholder="Enter Input">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Soal :</label>
                            <textarea class="form-control"  name="soal" id=""></textarea>
                        </div>
