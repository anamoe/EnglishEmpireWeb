                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{url('courseprogram')}}" id="buatmapel" method="post">
                                        @csrf
                                        <div class="form-group form-inline">
                                            <label for="namamapel" class="col-md-3 col-form-label">Program Course</label>
                                            <div class="col-md-9 p-0">
                                                <input type="text" class="form-control input-full w-100" name="program" id="namamapel" placeholder="Enter Input">
                                            </div>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" id="updatemapel" method="post">
                                        ...
                                        @csrf
                                        <div class="form-group form-inline">
                                            <label for="namamapel" class="col-md-3 col-form-label">Course Program</label>
                                            <div class="col-md-9 p-0">
                                                <input type="text" class="form-control input-full" name="program" id="editnamamapel" placeholder="Enter Input">
                                            </div>
                                        </div>
                    ...
                    <div class="mapel card-stats card-round col-sm-12 col-md-4">
                        <div class="card card-body">
                            <div class="float-right py-2 mt--2">
                                <i onclick="hapus('{{$v->id}}','{{$v->program}}')" class="fe fe-trash float-right text-danger"></i>
                                <i onclick="edit('{{$v->id}}','{{$v->program}}')" class="fe fe-edit float-right text-primary"></i>

                            </div>
                            <a href="{{url('courseprogram/class',$v->id)}}"  class="row align-items-center">
                                <div class="col-icon">
...
<script type="text/javascript">
    ...
    function edit(id, mapel) {
        ...
        $("#updatemapel").attr("action", "{{url('courseprogram')}}" + "/" + id)
        $("#editMapel").modal("show")
    }

    function hapus(id, mapel) {
        $("#hapusmapel .map").html(mapel)
        $("#deletemapel").attr("action", "{{url('courseprogram')}}" + "/" + id)
