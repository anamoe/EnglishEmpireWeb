...
@endsection
@section('judul','Answer Student Point')
            ...
            <div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
                <div class="tab-pane fade show active" id="pills-home-icon" role="tabpanel" aria-labelledby="pills-home-tab-icon">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form" id="formkirim" method="POST" action="{{url('hapus-answer-all')}}">
                                @csrf
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: black; font-weight: bold;">Sub Category</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('kelolaanswerdelete',$v->id)}}" class="btn btn-danger" data-target="confirmation-modal">
