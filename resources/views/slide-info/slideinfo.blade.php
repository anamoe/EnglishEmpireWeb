                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$no1++}}</td>
                                            <td>  <img class="img" id="loadfotoadd" src="{{url('public/slide-info/'.$v->image)}}" alt="Foto Thumbnail"
                                        style=" height:30px; width:50px;">     </td>
                                            <td>

                                                <a href="{{url('slideinfo',$v->id)}}" class="btn btn-primary">
                                                    <i class="fe fe-edit"></i>
                                                </a>
                                                <a href="{{url('slideinfodelete',$v->id)}}" class="btn btn-danger" data-target="confirmation-modal">
    ...
    <div class="row">
        <div class="col-md-12  mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{url('slideinfo')}}" enctype="multipart/form-data" id="submitdata">
                        @csrf
