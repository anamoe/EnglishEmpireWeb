        ...
        <div class="col-md-12  mt-5">
           <div class="card">
              ...
              <div class="card-header bg-primary">
                 ...
                 <h6 class="text-white">Edit<div class="float-right kembalimateri" style="cursor :pointer;"></div> </h6>
              </div>
              <div class="card-body">
                 <form method="post" action="{{url('slideinfo/'.$informasi->id)}}" enctype="multipart/form-data" id="submitdata">
                    @csrf
                    @method('PUT')
