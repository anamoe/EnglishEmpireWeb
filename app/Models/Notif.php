...
class Notif
{
    ...
    public function sendNotifAll($token, $pesan, $judul)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => $field,
            CURLOPT_HTTPHEADER => array(
                'Authorization: key=AAAAGd0tx5U:APA91bHL1PWaMPOUwNkR_Cw8XaLtMP-Nj0lGcbpXZ_HGDp44y9SycDWNZW4mZorbTZImfsAjRZNGujjAv_BgkFJpyE75acmF678Tp8mxRDG0MZbB1N_a5cnF8oLYMS49vCKiRqboIj3q',
                'Content-Type: application/json'
            ),
        ));
